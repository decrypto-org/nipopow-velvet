...
\begin{figure}[h!]
	...
	\end{center}
	\caption{The adversarial fork chain $\chain_\mathcal{A}$ and chain $\chain_B$ of an honest party. Thorny blocks are colored black. An adversarially generated block is sewed from $\chain_B$ into the adversary's suffix proof. \textbf{I:} the real picture of the chains, \textbf{II:} picture corresponding to the verifier's perspective considering the blocks included in the suffix proofs.}
	\label{fig:injection}
\end{figure}
