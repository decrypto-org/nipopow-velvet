...
Note that equivalent solution could be formed by using any authenticated data structure that provides inclusion proofs of size logarithmic to the length of the chain. We suggest MMRs because of their efficiency while updating, since they support efficient node addition and deletion operations.