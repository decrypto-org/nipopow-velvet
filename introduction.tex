...
cross-chain communication~\cite{pow-sidechains,burn,crosschain-sok}, mining~\cite{logspace}, as well as
local data consumption by smart contracts~\cite{derivatives}. Chain interlinking
has been proposed for both chains~\cite{compactsuperblocks} and DAGs~\cite{flydag}
